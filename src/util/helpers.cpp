...
namespace linkchat
{
    ...
    {
        return (static_cast<uint32_t>(buf[index]) << 24) |
    ...
    {
        return (static_cast<uint16_t>(buf[index]) << 8) |
